...
name := s"softclient4es${elasticSearchMajorVersion(elasticSearchVersion.value)}-testkit"

libraryDependencies ++= elastic4sTestkitDependencies(elasticSearchVersion.value) ++ Seq(
