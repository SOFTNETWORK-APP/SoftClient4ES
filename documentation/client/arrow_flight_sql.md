...
```bash
java -jar softclient4es8-arrow-flight-sql-0.3.2.jar
```

| Elasticsearch | Artifact |
|---------------|----------|
| ES 6.x | `softclient4es6-arrow-flight-sql-0.3.2.jar` |
| ES 7.x | `softclient4es7-arrow-flight-sql-0.3.2.jar` |
| ES 8.x | `softclient4es8-arrow-flight-sql-0.3.2.jar` |
| ES 9.x | `softclient4es9-arrow-flight-sql-0.3.2.jar` |
