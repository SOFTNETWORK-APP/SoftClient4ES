...
object DialectCensus {
  ...
  val timeArith: List[CensusEntry] = List(
    ...
    e(
      ...
      "DATE_ADD",
      PFt,
      "lazy val date_add_transact_sql : PackratParser[DateFunction with FunctionWithIdentifier " +
      "with DateMathScript]",
    ...
    e(
      ...
      "DATE_SUB",
      PFt,
      "lazy val date_sub_transact_sql : PackratParser[DateFunction with FunctionWithIdentifier " +
      "with DateMathScript]",
    ...
    e(
      ...
      "DATETIME_ADD",
      PFt,
      "lazy val datetime_add_transact_sql : PackratParser[DateTimeFunction with " +
    ...
    e(
      ...
      "DATETIME_SUB",
      PFt,
      "lazy val datetime_sub_transact_sql : PackratParser[DateTimeFunction with " +
      "FunctionWithIdentifier with DateMathScript]",
